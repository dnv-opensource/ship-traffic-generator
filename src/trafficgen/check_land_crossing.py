...
def path_crosses_land(position_1, speed, course, lat_lon_0, time_interval=50):
    ...
    for i in range(int(time_interval/num_checks)):
        position_2 = calculate_position_at_certain_time({'north': north_1, 'east': east_1},
                                                        speed, course, i*time_interval/num_checks)
        lat, lon, _ = flat2llh(position_2['north'], position_2['east'],
